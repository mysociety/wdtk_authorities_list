...
- title: Public Authorities
  ...
  schema:
    ...
    - name: tags
      ...
      constraints:
        unique: false
      example: 16_plus|Academy_16-19_converter|Greenwich|academies|school|school_new_nov2020|urn:138966
    - name: home-page
      type: string
    ...
    - name: updated-at
      ...
      constraints:
        unique: false
      example: 2013-09-24 11:58:18 +0100
    - name: version
      type: integer
  ...
  hash: 6fa255ac6e0a711c8059f9d5d835e0eb
- title: Categories
  ...
  schema:
    ...
    - name: category-name
      ...
      constraints:
        unique: true
      example: Academies
  hash: eb0add0a8bdc16245a1385cdfcba43ab
- title: Public authority ID lookup
  ...
  hash: f39e90699101e8e863ed48adbc683dec
full_version: 0.73.0
